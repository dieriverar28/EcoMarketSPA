...
import com.example.EcoMarketSPA.service.DevolucionReclamoService;
...
public class DevolucionReclamoController {
    ...
    public DevolucionReclamo busDevolucionReclamo(@PathVariable int id_devolucion_reclamo, @Valid @RequestBody DetallePedido detallePedido){
